...
TEST_COMPS_FILES_PATH = os.path.join(TEST_DATA_PATH, "comps_files/")
...
PKG_EMPTY_SIGNED_EDDSA = "empty-signed-eddsa-0-0.x86_64.rpm"
PKG_EMPTY_SIGNED_EDDSA_PATH = os.path.join(PACKAGES_PATH, PKG_EMPTY_SIGNED_EDDSA)

PKG_EMPTY_SIGNED_RSA = "empty-signed-rsa-0-0.x86_64.rpm"
PKG_EMPTY_SIGNED_RSA_PATH = os.path.join(PACKAGES_PATH, PKG_EMPTY_SIGNED_RSA)

PKG_EMPTY_SIGNED_V6_MULTIPLE = "empty-signed-v6-multiple-0-0.x86_64.rpm"
PKG_EMPTY_SIGNED_V6_MULTIPLE_PATH = os.path.join(PACKAGES_PATH, PKG_EMPTY_SIGNED_V6_MULTIPLE)
...
TEST_UPDATEINFO_00 = os.path.join(TEST_UPDATEINFO_FILES_PATH, "updateinfo_00.xml")
TEST_UPDATEINFO_01 = os.path.join(TEST_UPDATEINFO_FILES_PATH, "updateinfo_01.xml")
TEST_UPDATEINFO_02 = os.path.join(TEST_UPDATEINFO_FILES_PATH, "updateinfo_02.xml.xz")
TEST_UPDATEINFO_03 = os.path.join(TEST_UPDATEINFO_FILES_PATH, "updateinfo_03.xml")

# Test comps files

TEST_COMPS_00 = os.path.join(TEST_COMPS_FILES_PATH, "comps_00.xml")


def _generate_updaterecord_fixture():
    import datetime
...
TEST_UPDATERECORD_UPDATE1 = _generate_updaterecord_fixture()